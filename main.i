...
extern OZI ozi;
extern SMALLALIEN smallalien[3];
extern LIVES playerLife[3];
extern LIVES oziLife[3];

extern SMALLALIEN secondHalf[3];
extern LIVES secondVersion[3];
...
# 12 "main.c" 2
# 1 "levelTwoStartScreen.h" 1
# 22 "levelTwoStartScreen.h"
extern const unsigned short levelTwoStartScreenTiles[4368];


extern const unsigned short levelTwoStartScreenMap[1024];


extern const unsigned short levelTwoStartScreenPal[256];
# 13 "main.c" 2
# 1 "levelThreeStartScreen.h" 1
# 22 "levelThreeStartScreen.h"
extern const unsigned short levelThreeStartScreenTiles[3664];


extern const unsigned short levelThreeStartScreenMap[1024];


extern const unsigned short levelThreeStartScreenPal[256];
# 14 "main.c" 2
# 1 "levelTwoWin.h" 1
# 22 "levelTwoWin.h"
extern const unsigned short levelTwoWinTiles[4992];


extern const unsigned short levelTwoWinMap[1024];


extern const unsigned short levelTwoWinPal[256];
# 15 "main.c" 2
# 1 "levelThreeWin.h" 1
# 22 "levelThreeWin.h"
extern const unsigned short levelThreeWinTiles[4464];


extern const unsigned short levelThreeWinMap[1024];


extern const unsigned short levelThreeWinPal[256];
# 16 "main.c" 2
...
extern const unsigned int levelSong_sampleRate;
extern const unsigned int levelSong_length;
extern const signed char levelSong_data[];
# 19 "main.c" 2
# 1 "crashSound.h" 1


extern const unsigned int crashSound_sampleRate;
extern const unsigned int crashSound_length;
extern const signed char crashSound_data[];
# 20 "main.c" 2
# 1 "fireball.h" 1


extern const unsigned int fireball_sampleRate;
extern const unsigned int fireball_length;
extern const signed char fireball_data[];
# 21 "main.c" 2
# 1 "bump.h" 1


extern const unsigned int bump_sampleRate;
extern const unsigned int bump_length;
extern const signed char bump_data[];
# 22 "main.c" 2
# 1 "winSound.h" 1
...
extern const unsigned int finalWinSound_sampleRate;
extern const unsigned int finalWinSound_length;
extern const signed char finalWinSound_data[];
# 24 "main.c" 2
# 1 "loseSound.h" 1
...
extern const unsigned int ghostSound_sampleRate;
extern const unsigned int ghostSound_length;
extern const signed char ghostSound_data[];
# 26 "main.c" 2
# 1 "slowGhostSound.h" 1


extern const unsigned int slowGhostSound_sampleRate;
extern const unsigned int slowGhostSound_length;
extern const signed char slowGhostSound_data[];
# 27 "main.c" 2
# 1 "layerOne.h" 1
# 22 "layerOne.h"
...
void goToStart() {
    ...
    DMANow(3, menuTiles, &((charblock *)0x6000000)[0], 14080 / 2);
...
void goToInstructions() {
    ...
    DMANow(3, instructionsTiles, &((charblock *)0x6000000)[0], 13248 / 2);
...
void goToGame() {
    ...
    (*(volatile unsigned short *)0x4000000) = 0 | (1<<10) | (1<<9) | (1<<12);
    DMANow(3, shadowOAM, ((OBJ_ATTR*)(0x7000000)), 512);

    DMANow(3, layerOnePal, ((unsigned short *)0x5000000), 512/2);
    (*(volatile unsigned short*)0x400000C) = (1<<14) | ((0)<<2) | ((28)<<8) | (0<<7);
    DMANow(3, layerOneTiles, &((charblock *)0x6000000)[0], 10176 / 2);
    DMANow(3, layerOneMap, &((screenblock *)0x6000000)[28], 4096 / 2);
    (*(volatile unsigned short*)0x400000A) = (0<<14) | ((1)<<2) | ((27)<<8) | (0<<7);
    DMANow(3, layerTwoTiles, &((charblock *)0x6000000)[1], 6944/2);
    DMANow(3, layerTwoMap, &((screenblock *)0x6000000)[27], 2048/2);
...
void goToLevelTwoStart() {
    ...
    isLevel2Active = 1;
    DMANow(3, shadowOAM, ((OBJ_ATTR*)(0x7000000)), 512);
    DMANow(3, levelTwoStartScreenPal, ((unsigned short *)0x5000000), 512 / 2);
    DMANow(3, levelTwoStartScreenTiles, &((charblock *)0x6000000)[0], 8736 / 2);
    DMANow(3, levelTwoStartScreenMap, &((screenblock *)0x6000000)[28], 2048 / 2);
...
void levelTwoGame() {
    ...
    if ((!(~(oldButtons)&((1<<3))) && (~buttons & ((1<<3))))) {
     ...
     if (oziLives <= 0 && secondOziLives <= 0) {
        goToLevelTwoWin();
    }
}
...
void goToLevelTwoWin() {
    ...
    DMANow(3, shadowOAM, ((OBJ_ATTR*)(0x7000000)), 512);
    DMANow(3, levelTwoWinPal, ((unsigned short *)0x5000000), 512 / 2);
    DMANow(3, levelTwoWinTiles, &((charblock *)0x6000000)[0], 9984 / 2);
    DMANow(3, levelTwoWinMap, &((screenblock *)0x6000000)[28], 2048 / 2);
...
void goToLevelThreeStart() {
    ...
    DMANow(3, levelThreeStartScreenPal, ((unsigned short *)0x5000000), 512 / 2);
    DMANow(3, levelThreeStartScreenTiles, &((charblock *)0x6000000)[0], 7328 / 2);
    DMANow(3, levelThreeStartScreenMap, &((screenblock *)0x6000000)[28], 2048 / 2);
...
void goToLevelThreeWin() {
    ...
    DMANow(3, shadowOAM, ((OBJ_ATTR*)(0x7000000)), 512);
    DMANow(3, levelThreeWinPal, ((unsigned short *)0x5000000), 512 / 2);
    DMANow(3, levelThreeWinTiles, &((charblock *)0x6000000)[0], 8928 / 2);
    DMANow(3, levelThreeWinMap, &((screenblock *)0x6000000)[28], 2048 / 2);
...
void goToPause() {
    ...
    DMANow(3, pauseTiles, &((charblock *)0x6000000)[0], 6688 / 2);
...
void goToWin() {
    ...
    DMANow(3, winTiles, &((charblock *)0x6000000)[0], 8928 / 2);
...
void goToLose() {
    ...
    DMANow(3, loseTiles, &((charblock *)0x6000000)[0], 8672 / 2);
